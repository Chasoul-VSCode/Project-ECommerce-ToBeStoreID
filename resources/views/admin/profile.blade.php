          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-5 grid-margin stretch-card">
                  <div class="card">
                      <div class="card-body">
                          <h4 class="card-title">Edit Profile Biodata</h4>
                          <form class="forms-sample" action="" method="POST" enctype="multipart/form-data">
                              @csrf
                              <div class="form-group">
                                  <label for="nama_seller">Nama Seller</label>
                                  <input type="text" class="form-control" id="nama_seller" name="nama_seller" placeholder="Nama Seller" value="" required>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="no_wa" name="no_wa" placeholder="Nomor WhatsApp" value="" required>
                              </div>
                              <div class="form-group">
              ...
              <div class="col-md-7 grid-margin stretch-card">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <div class="form-group">
                              <textarea class="form-control textarea-expanded" style="height: 220px" id="deskripsi" name="deskripsi" placeholder="Deskripsi"></textarea>
                          </div>
                          <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" placeholder="Tanggal Lahir" value="" required>
                        </div>
                          <div class="form-group">
